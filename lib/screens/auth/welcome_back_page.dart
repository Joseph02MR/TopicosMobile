...
class _WelcomeBackPageState extends State<WelcomeBackPage> {
  ...
  TextEditingController email =
      TextEditingController(text: 'lejose@gmail.com');

  TextEditingController password = TextEditingController(text: 'pass123');
  ...
  Widget build(BuildContext context) {
    ...
    Widget loginButton = Positioned(
      ...
      child: InkWell(
        onTap: () async {
          user = await RemoteService().getUserforLogin(email.text, password.text);
          if(user != null) {
